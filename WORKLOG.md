...
- Next action: commit/push the repaired serverless metadata, retry the prebuilt deployment, then verify the unauthenticated public URL asset-by-asset before treating it as the judge path.
