...
- Next action: commit and push the reproducible deployment boundary, deploy the prebuilt output, then verify the unauthenticated public URL asset-by-asset before treating it as the judge path.
